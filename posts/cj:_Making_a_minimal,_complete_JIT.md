...
7 years ago, I had an idea for [a JIT compiler](https://github.com/hellerve-pl-experiments/cj/) in C for x86 architectures with a completely auotgenerated backend based on machine-readable information on the instructions. Sounds cool, right?!
