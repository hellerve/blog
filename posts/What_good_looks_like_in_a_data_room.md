---
title: "What “good” looks like in a data room"
date: 2025-09-03
---
...
2. Prepared documents. You didn’t throw something together ad-hoc when I asked for an [SBOM](/Some_notes_about_SBOMs.html), or documentation on your backup policy and disaster recovery procedures. You had them ready, and you know about them.
...
5. (Provided code access is given) To get a 30,000-feet level view of your code’s organization, your repository structure, and your build health, I don’t need to have access to your full employee handbook or onboarding docs (although ideally I do).
...
If you have all of that, we’ll be good friends. I don’t need all of it on day one, but ideally I have access to the relevant docs 2 or more hours before my interviews with the relevant person, 24 hours if you really want to become besties.

## What you can do

These documents fall naturally out of healthy processes. Ideally you have an SBOM already (holla if you need help with that), and your finance person, be it a CFO or your accountant firm, lets you look at a P&L sheet from time to time, you know, just in case.
...
I recently wrote a few blog posts about simple [SBOMs](/Some_notes_about_SBOMs.html) and [SSDLCs](/Simple_SSDLCs.html), and I intend to write one about simple threat models soon. Check them out if you need help getting started with professionalizing your development flow, and let me know if you need more help. I’m always available for general questions and as a sparring partner, not just as a gun for hire.
